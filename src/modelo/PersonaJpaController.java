    ...
    public void create(Persona persona) {
        ...
        try {
            ...
            for (Usuario usuarioListUsuario : persona.getUsuarioList()) {
                Persona oldIdpersonauOfUsuarioListUsuario = usuarioListUsuario.getIdpersonaUsu();
                usuarioListUsuario.setIdpersonaUsu(persona);
        ...
        try {
            ...
            for (Usuario usuarioListOldUsuario : usuarioListOld) {
                if (!usuarioListNew.contains(usuarioListOldUsuario)) {
                    usuarioListOldUsuario.setIdpersonaUsu(null);
                    usuarioListOldUsuario = em.merge(usuarioListOldUsuario);
                }
            }
            for (Usuario usuarioListNewUsuario : usuarioListNew) {
                if (!usuarioListOld.contains(usuarioListNewUsuario)) {
                    Persona oldIdpersonauOfUsuarioListNewUsuario = usuarioListNewUsuario.getIdpersonaUsu();
                    usuarioListNewUsuario.setIdpersonaUsu(persona);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            for (Usuario usuarioListUsuario : usuarioList) {
                usuarioListUsuario.setIdpersonaUsu(null);
                usuarioListUsuario = em.merge(usuarioListUsuario);
            }
            em.remove(persona);
            em.getTransaction().commit();
